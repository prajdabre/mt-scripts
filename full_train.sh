#!/bin/bash
export LANG=en_IN
MGIZA=/var/www/smt/mgizapp
cd /var/www/smt/mgizapp/train-ENG-HIN
mkdir corpus
mkdir giza.fwd
mkdir giza.inv
cp $1 $2 corpus/
...
$MGIZA/bin/mkcls -n1 -c50 -pcorpus/$1  -Vcorpus/$1.vcb.classes
$MGIZA/bin/mkcls -n1 -c50 -pcorpus/$2  -Vcorpus/$2.vcb.classes
